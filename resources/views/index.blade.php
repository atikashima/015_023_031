	...
	<main class="row">
		...
		<div class="col-8 col-lg-10 main-content pleft">
				<div class="col-12 pic-content">
					<div class="col-12 brown title-content">Kabar Berita</div>
				...
				<div class="col-12 pic-content bbot">
					<div class="col-12 title-content grey">Advertisement</div>
					<div class="col-5 main-val">
						

					<iframe src="https://www.youtube.com/embed/T88lN8AWvnU"></iframe>
						<div class="col-9"><a href="/iklan"><img src="/img/iklan.png"></a></div>
					</div>
				</div>
				<div class="col-12 pic-content bbot">
