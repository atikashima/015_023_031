...
<body>
	...
	<header class="row">
		<div class="col-2 col-lg-10 offset-1 logo">
			<div class="col-8 logo-main"><img src="/img/warta1.png"></div>
			<div class="col-12 logo-small">Kabar Berita Terupdate</div>
		</div>
		<nav class="col-10 offset-1 nav-header">
			<ul>
				<a href="/" class="col-1"><li>Home</li></a>
				<a href="/kategori/Nasional"  class="col-1"><li>Nasional</li></a>
				<a href="/kategori/Edukasi"   class="col-1"><li>LuarNegeri</li></a>
				...
				<a href="/kategori/Internasional"    class="col-1"><li>Edukasi</li></a>
				@if(Auth::guest())
		...
		@else <div id="log-menu" style="top: 25%">
		@endif
			@if(Auth::guest())
	...
	@yield('content')
			...
			<div class="col-4 col-lg-10 main-content pright">
				<div class="col-12 pic-content">
					<div class="col-12 title-sub-content pinks">Artikel Populer</div>
				...
				<div class="col-12 pic-content bbotn">
					<div class="col-12 title-sub-content pink">Berita Terbaru</div>
					<div class="col-12 main-val">
				...
				<div class="col-12 pic-content bbotn">
					<div class="col-12 title-sub-content brown">About Us</div>
					<div class="col-12 main-val">
							
								<div class="col-9"><img src="/img/warta1.png"></div>		
							
					</div>
				</div>
				<div class="mt-1">Warna Warta Adalah Web Portal Berita Terupdate yang digunakan untuk memenuhi ujian akhir mata kuliah Pemrograman Web. <br> Telp : 0818283848586 <br> Email : WarnaWarta@gmail.com <br> Alamat : Ketintang A10 Unesa </div>
			</div>
	...
	<footer class="row">
		<div class="col-12 copyright">Copyright &copy; ATIKA PUTRI DEA SISTEM INFORMASI 2018 A</div>
	</footer>
