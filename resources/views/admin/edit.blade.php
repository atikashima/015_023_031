	...
	<div class="col-10 col-lg-8 main-admin">
		...
		<form class="col-12" action="/editPost/{{ $berita->id }}" method="POST" enctype="multipart/form-data">
			...
			<div class="col-12 main-cat">
				...
				<input type="checkbox" name="kategori[]" value="Edukasi"<?php cek('Edukasi', $berita); ?>>LuarNegeri
				...
				<input type="checkbox" name="kategori[]" value="Internasional"<?php cek('Internasional', $berita); ?>>Edukasi
			</div>
